...
- 🔭 Building full-stack web apps — and teaching microcontrollers a few new tricks on the side
- 🌱 Sharpening my DSA on **LeetCode**, **GeeksforGeeks** & **HackerRank**
- 🧰 Comfortable across the stack — React and Node on the web, Arduino and ESP32 on the breadboard
- 💼 Open to freelance work — you'll find me on **Fiverr**
- ⚡ Fun fact: there's a decent chance I have a breadboard within arm's reach right now
- 📫 Reach out — details are just below 👇
...
![Mapbox GL JS](https://img.shields.io/badge/Mapbox_GL_JS-000000?style=for-the-badge&logo=mapbox&logoColor=white)
...
<!-- TODO before publishing: swap every placeholder link below (email, LinkedIn, Fiverr, GFG, LeetCode) for your real profile URLs -->
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=wave&color=0:7209B7,100:F72585&height=100&section=footer" alt="Footer wave banner" />
